...
//SUSTANTIVOS
"Dog" | "dog" | "DOG" {lexeme = yytext(); return perro;}
"Car" | "car" | "CAR" {lexeme = yytext(); return carro;}
"Book" | "book" | "BOOK" {lexeme = yytext(); return libro;}
"House" | "house" | "HOUSE" {lexeme = yytext(); return casa;}
"Cat" | "cat" | "CAT" {lexeme = yytext(); return gato;}
"Chair" | "chair" | "CHAIR" {lexeme = yytext(); return silla;}
"Tree" | "tree" | "TREE" {lexeme = yytext(); return árbol;}
"Flower" | "flower" | "FLOWER" {lexeme = yytext(); return flor;}
"Table" | "table" | "TABLE" {lexeme = yytext(); return mesa;}
"Pen" | "pen" | "PEN" {lexeme = yytext(); return bolígrafo;}
"Computer" | "computer" | "COMPUTER" {lexeme = yytext(); return computadora;}
"Phone" | "phone"| "PHONE" {lexeme = yytext(); return teléfono;}
"Sun" | "sun"| "SUN" {lexeme = yytext(); return sol;}
"Bookshelf" | "bookshelf" | "BOOKSHELF" {lexeme = yytext(); return estantería;}
...
"ninetysecond "|"Ninetysecond "|"NINETYSECOND " {lexeme=yytext(); return nonagesimosegundo;}
"ninetythird "|"Ninetythird "|"NINETYTHIRD " {lexeme=yytext(); return nonagesimotercero;}
